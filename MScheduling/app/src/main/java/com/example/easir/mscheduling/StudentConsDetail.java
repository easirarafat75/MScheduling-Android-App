                                    ...
                                    public void run() {
                                        try {
                                            String msg="Dear Student,\n" +
                                                    "You have canceled a consultation for "+date+
                                                    "\nFor more details please log in to your account.";
                                            sendmail(userName,"Consultation Canceling",msg);
                                            msg="Dear Lecturer,\n" +
                                                    "A Student has canceled a consultation with you for "+date+
                                                    "\nFor more details please log in to your account.";
                                            sendmail(lecemail,"Consultation Canceling",msg);
